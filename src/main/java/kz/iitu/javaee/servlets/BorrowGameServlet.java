...
@WebServlet(value = "/borrowGame")
public class BorrowGameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (game != null) {
            ...
            int borrowed = dbConnection.borrowGame(userId, game);

            if (borrowed != 0) {
                request.setAttribute("message", "Game "+ game.getTitle()+" borrowed by You successfully!");
